...
st.set_page_config(page_title="ENG Premier League Overview")
...
with st.sidebar:
    ...
    st.write("This App was designed in order to get an overview of English Premier League regarding xG Open Play Per 100 Passes")
...
#get data
df = get_data(league=LEAGUE, season=YEAR, country='ENG', teams=teams)
